...
Thank you for your interest in contributing to Exa! We welcome contributions from the community to help improve usability and readability. By contributing, you can be a part of creating a dynamic and interactive AI system.
...
To continuously improve Exa, we prioritize the following design objectives:
...
Our goal is to continuously improve Exa by following this roadmap while also being adaptable to new needs and opportunities as they arise.

## Join the Exa Community

Join the Exa community on Discord to connect with other contributors, coordinate work, and receive support.

- [Join the Exa Discord Server](https://discord.gg/qUtxnK2NMf)
...
Exa docs are built using [MkDocs](https://squidfunk.github.io/mkdocs-material/getting-started/). 

To directly contribute to Exa documentation, first fork the [Exa-docs](https://github.com/kyegomez/Exa) repository to your GitHub account. Then clone your repository to your local machine.

From inside the directory run: 

```pip install -r requirements.txt```

To run `Exa-docs` locally run: 
...
1. Visit the [Exa GitHub repository](https://github.com/kyegomez/Exa) and browse through the existing issues.
...
To contribute your changes to Exa, please follow these steps:

1. Fork the Exa repository to your GitHub account. You can do this by clicking on the "Fork" button on the repository page.
...
9. Create a pull request (PR) from your branch to the main Exa repository. Provide a clear and concise description of your changes in the PR.
...
12. Once your changes have been reviewed and approved, they will be merged into the main branch of the Exa repository.

13. Congratulations! You have successfully contributed to Exa.
...
If you are interested in setting up the Exa development environment, please follow the instructions provided in the [developer setup guide](docs/developer-setup.md). This guide provides an overview of the different tools and technologies used in the project.

## Join the Agora Community

Exa is brought to you by Agora, the open-source AI research organization. Join the Agora community to connect with other researchers and developers working on AI projects.

- [Join the Agora Discord Server](https://discord.gg/qUtxnK2NMf)

Thank you for your contributions and for being a part of the Exa and Agora community! Together, we can advance Humanity through the power of AI.